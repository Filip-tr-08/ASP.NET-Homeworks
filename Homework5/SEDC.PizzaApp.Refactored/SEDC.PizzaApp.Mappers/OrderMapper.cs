    ...
    public static class OrderMapper
    {
        ...
        public static OrderDetailsViewModel ToOrderDetailsViewModel(this Order order)
        {
            return new OrderDetailsViewModel
            {
                ...
                UserFullName = $"{order.User.FirstName} {order.User.LastName}",
                //Pizzas = order.PizzaOrders.Select(x => x.Pizza).ToList(),
                Pizzas = order.PizzaOrders,
                Id = order.Id
            };
        }
        ...
        public static PizzaOrder PizzaOrderViewModelToPizzaOrder(this PizzaOrderViewModel pizzaOrderViewModel)
        {
            return new PizzaOrder
            {
                Id = pizzaOrderViewModel.Id,
                OrderId=pizzaOrderViewModel.OrderId
            };
        }
